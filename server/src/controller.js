...
export default class Controller {
    ...
    #updateGlobalUserData(socketId, userData) {
        ...
        const user = users.get(socketId) ?? {} // Se não existir retorna um objeto vazio
